...
import consecutiveSession.AddConsecutiveSession;
...
public class StudentTimeTable {
	...
	private void initialize() {
		...
		panel.setBackground(Color.decode("#4660BD"));
		...
		btnTimetableGenerator.setBackground(Color.WHITE);
		btnTimetableGenerator.setBounds(0, 1, 233, 74);
		...
		JButton btnTimetableGenerator1 = new JButton("TIMETABLE GENERATOR");
		btnTimetableGenerator1.setForeground(Color.BLACK);
		btnTimetableGenerator1.setFont(new Font("Times New Roman", Font.BOLD, 16));
		btnTimetableGenerator1.setBackground(Color.decode("#FF7A48"));
		btnTimetableGenerator1.setBounds(10, 10, 233, 74);
		...
		btnNewButton_9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				LectureTimeTable tt=new LectureTimeTable();
				tt.main(null);
				frame.setVisible(false);
			}
		});
